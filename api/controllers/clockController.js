...
exports.createTimesheet = async function(req,res){
    var domainID = req.params.domainID;
    var periodNumber = req.params.period;
    var year = req.params.year;
    ...
    await Timesheet.findOne({"domain_id" : domainID, "period_number": periodNumber, "year": year}, function(err, timesheet){
        ...
        if(timesheet){
            res.send("Timesheet for this period already exists!");
        }else{
            Period.findOne({"period_number": periodNumber, "year": year})
